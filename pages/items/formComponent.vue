<template>
    <view>
        <u-modal title="成功" :show-cancel-button="true" v-model="modelShow" @cancel="modelCancel" @confirm="modelConfirm" :content="'您的线索已提交'"></u-modal>
        <u-toast ref="uToast" />
        <u-navbar :back-text-style="{color:'#409eff'}" :is-back="false" back-icon-color="#409eff" :custom-back="customBack"
            title-width="400" back-text="返回" :title="title"></u-navbar>
            <view class="wrapper">
               <u-form class="main-form" :error-type="['border-bottom','toast']" label-align="left" label-width="calc(112rpx + 18px)"
                   ...
                   <u-form-item required label="举报地点" prop="place">
                       <u-cell-group :border="false">
                           <u-cell-item @click="getPlace" :border-bottom="false" hover-class="none" :title="form.place" value="选择地点"></u-cell-item>
                       </u-cell-group>
                   </u-form-item>
                   <u-form-item style="position: relative;" label-position="top" label-align="left" required label="线索描述" prop="desc">
                       <u-input style="margin-bottom: 6px;" v-model="form.desc" placeholder="" :trim="false" type="textarea"
                           :auto-height="true" placeholder="请输入" :maxlength="200" />
